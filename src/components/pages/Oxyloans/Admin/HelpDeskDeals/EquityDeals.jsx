  ...
  const fetchDeals = async (type = dealType, pageNo = currentPage) => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://fintech.oxyloans.com/oxyloans/v1/user/40016/listOfDealsInformationForEquityDeals',
        payload,
        {
          headers: {
      ...
      console.error('Error fetching deals:', error.response.status);
    ...
    },
    {
      ...
      render: (_, record) => (
        <div style={{ whiteSpace: 'pre-wrap', wordBreak: 'break-word', maxWidth: 250 }}>
          ...
          <div><strong>EMI End Date:</strong> {record.emiEndDate}</div>
        </div>
      ),
    },
  ];
      ...
      <div className="page-wrapper">
        <div className="content container-fluid">
          <div className="page-header">
            <div className="row">
              <h4 className="page-title"> Running & Closed Equity Deals</h4>
              <div className="col">
