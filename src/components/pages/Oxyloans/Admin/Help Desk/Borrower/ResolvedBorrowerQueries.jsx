...
export default function ResolvedBorrowerQueries() {
          ...
          <div className="main-wrapper">
            ...
            <div className="p-4 overflow-y-auto h-full">
              <div className="bg-white rounded-md shadow-md p-4 overflow-x-auto">
                <h3 className="text-xl font-semibold mb-4">Resolved Borrower Queries</h3>
                <h6 className="text-xl font-semibold mb-4">No of Borrower Resolved queries : {totalCount}</h6>
