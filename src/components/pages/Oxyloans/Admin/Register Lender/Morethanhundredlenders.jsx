...
import {
    handlemorethanhundreddealsparticipated,
...
const Morethanhundredlenders = () => {
  ...
  const fetchDownloadReport = async () => {
    setLoading(true);
    const response = await handlemorethanhundreddealsparticipated();
    ...
    <div className="main-wrapper">
      ...
      <div className="page-wrapper">
        <div className="content container-fluid">
          <h3 level={4}>More than hundred deal paticipated Lenders</h3>
            ...
            <div className="mb-4 d-flex align-items-center flex-wrap">
              <div>
                ...
                <span className="bg-light text-danger px-1 py-1 rounded d-inline-block">
                    Displaying More than hundred deal paticipated Lenders.
                </span>
              </div>
...
export default Morethanhundredlenders;
