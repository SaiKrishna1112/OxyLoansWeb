...
import {
  handleWalletloadednotpaticipatedDownloadReport,
...
const Walletloadednotpaticipated = () => {
  ...
  const fetchDownloadReport = async () => {
    setLoading(true);
    const response = await handleWalletloadednotpaticipatedDownloadReport();
    console.log("handlefetchDownloadReport", response);
    setLoading(false);
            ...
            <div className="mb-4 d-flex align-items-center flex-wrap">
              <div>
                ...
                <span className="bg-light text-danger px-1 py-1 rounded d-inline-block">
                    Download idle lenders report: lenders who paused lending 1-6 months ago but 
                    haven’t reached their ₹50 lakh limit
                </span>
              </div>
...
export default Walletloadednotpaticipated;
