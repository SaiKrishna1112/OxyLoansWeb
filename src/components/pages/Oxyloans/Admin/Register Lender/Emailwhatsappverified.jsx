...
const Emailwhatsappverified = () => {
  ...
  const fetchDownloadReport = async () => {
    setLoading(true);
    const response = await handleEmailwhatsappverified();
    ...
    <div className="main-wrapper">
      ...
      <div className="page-wrapper">
        <div className="content container-fluid">
          <h3 level={4}>Email whatsapp not verified lenders</h3>
            ...
            <div className="mb-4 d-flex align-items-center flex-wrap">
              <div>
                ...
                <span className="bg-light text-danger px-1 py-1 rounded d-inline-block">
                        Displaying Email whatsapp not verified lenders .
                </span>
              </div>
...
export default Emailwhatsappverified;
