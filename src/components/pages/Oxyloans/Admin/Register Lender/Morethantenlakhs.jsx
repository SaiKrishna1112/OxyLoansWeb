...
const Morethantenlakhs = () => {
  ...
  const fetchDownloadReport = async () => {
    setLoading(true);
    const response = await handleMorethantenlakhs();
    console.log("handle more than ten lakhs", response.status);
    setLoading(false);
    ...
    <div className="main-wrapper">
      ...
      <div className="page-wrapper">
        <div className="content container-fluid">
          <h3 level={4}>More than tenlakhs interest earned Lenders</h3>
          ...
          <Card className="col-10">
            <div className="mb-4 d-flex align-items-center flex-wrap">
              <div>
                ...
                Displaying more than tenlakhs interest earned Lenders.
                </span>
              </div>
...
export default Morethantenlakhs;
