...
const Onlytwiceparticpated = () => {
  ...
  const fetchDownloadReport = async () => {
    setLoading(true);
    const response = await handletwiceparticipated();
    console.log("handletwiceparticipated", response.status);
    setLoading(false);
    if (response.status === 200) {
      setDownload(response.data.lenderPaticipationExcelLink);
    } else {
    ...
    <div className="main-wrapper">
      ...
      <div className="page-wrapper">
        <div className="content container-fluid">
          <h3 level={4}>Only twice paticipated Lenders</h3>
          ...
          <Card className="col-10">
            <div className="mb-4 d-flex align-items-center flex-wrap">
              <div>
                ...
                Displaying users Only twice paticipated Lenders.
                </span>
              </div>
...
export default Onlytwiceparticpated;
